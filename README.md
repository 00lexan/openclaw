# ðŸ¦ž  â€” Personal AI Assistant

<p align="center">
    <picture>
        <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com///main/docs/assets/-logo-text-dark.png">
        <img src="https://raw.githubusercontent.com///main/docs/assets/-logo-text.png" alt="" width="500">
    </picture>
</p>
...
<p align="center">
  <a href="https://github.com///actions/workflows/ci.yml?branch=main"><img src="https://img.shields.io/github/actions/workflow/status///ci.yml?branch=main&style=for-the-badge" alt="CI status"></a>
  <a href="https://github.com///releases"><img src="https://img.shields.io/github/v/release//?include_prereleases&style=for-the-badge" alt="GitHub release"></a>
  <a href="https://discord.gg/clawd"><img src="https://img.shields.io/discord/1456350064065904867?label=Discord&logo=discord&logoColor=white&color=5865F2&style=for-the-badge" alt="Discord"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg?style=for-the-badge" alt="MIT License"></a>
</p>

**** is a _personal AI assistant_ you run on your own devices.
...
[Website](https://.ai) Â· [Docs](https://docs..ai) Â· [DeepWiki](https://deepwiki.com//) Â· [Getting Started](https://docs..ai/start/getting-started) Â· [Updating](https://docs..ai/install/updating) Â· [Showcase](https://docs..ai/start/showcase) Â· [FAQ](https://docs..ai/start/faq) Â· [Wizard](https://docs..ai/start/wizard) Â· [Nix](https://github.com//nix-clawdbot) Â· [Docker](https://docs..ai/install/docker) Â· [Discord](https://discord.gg/clawd)

Preferred setup: run the onboarding wizard (` onboard`). It walks through gateway, workspace, channels, and skills. The CLI wizard is the recommended path and works on **macOS, Linux, and Windows (via WSL2; strongly recommended)**.
Works with npm, pnpm, or bun.
New install? Start here: [Getting started](https://docs..ai/start/getting-started)
...
Model note: while any model is supported, I strongly recommend **Anthropic Pro/Max (100/200) + Opus 4.5** for longâ€‘context strength and better promptâ€‘injection resistance. See [Onboarding](https://docs..ai/start/onboarding).

## Models (selection + auth)

- Models config + CLI: [Models](https://docs..ai/concepts/models)
- Auth profile rotation (OAuth vs API keys) + fallbacks: [Model failover](https://docs..ai/concepts/model-failover)
...
Full beginner guide (auth, pairing, channels): [Getting started](https://docs..ai/start/getting-started)
...
# Send a message
 message send --to +1234567890 --message "Hello from "

# Talk to the assistant (optionally deliver back to any connected channel: WhatsApp/Telegram/Slack/Discord/Google Chat/Signal/iMessage/BlueBubbles/Microsoft Teams/Matrix/Zalo/Zalo Personal/WebChat)
 agent --message "Ship checklist" --thinking high
```

Upgrading? [Updating guide](https://docs..ai/install/updating) (and run ` doctor`).
...
Switch channels (git + npm): ` update --channel stable|beta|dev`.
Details: [Development channels](https://docs..ai/install/development-channels).
...
Note: `pnpm  ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `` binary.

## Security defaults (DM access)

 connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs..ai/gateway/security)

Default behavior on Telegram/WhatsApp/Signal/iMessage/Microsoft Teams/Discord/Google Chat/Slack:

- **DM pairing** (`dmPolicy="pairing"` / `channels.discord.dm.policy="pairing"` / `channels.slack.dm.policy="pairing"`): unknown senders receive a short pairing code and the bot does not process their message.
- Approve with: ` pairing approve <channel> <code>` (then the sender is added to a local allowlist store).
- Public inbound DMs require an explicit opt-in: set `dmPolicy="open"` and include `"*"` in the channel allowlist (`allowFrom` / `channels.discord.dm.allowFrom` / `channels.slack.dm.allowFrom`).

Run ` doctor` to surface risky/misconfigured DM policies.

## Highlights

- **[Local-first Gateway](https://docs..ai/gateway)** â€” single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs..ai/channels)** â€” WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, BlueBubbles (iMessage), iMessage (legacy), Microsoft Teams, Matrix, Zalo, Zalo Personal, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs..ai/gateway/configuration)** â€” route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs..ai/nodes/voicewake) + [Talk Mode](https://docs..ai/nodes/talk)** â€” always-on speech for macOS/iOS/Android with ElevenLabs.
- **[Live Canvas](https://docs..ai/platforms/mac/canvas)** â€” agent-driven visual workspace with [A2UI](https://docs..ai/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs..ai/tools)** â€” browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs..ai/platforms/macos)** â€” macOS menu bar app + iOS/Android [nodes](https://docs..ai/nodes).
- **[Onboarding](https://docs..ai/start/wizard) + [skills](https://docs..ai/tools/skills)** â€” wizard-driven setup with bundled/managed/workspace skills.

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=/&type=date&legend=top-left)](https://www.star-history.com/#/&type=date&legend=top-left)

## Everything we built so far

### Core platform

- [Gateway WS control plane](https://docs..ai/gateway) with sessions, presence, config, cron, webhooks, [Control UI](https://docs..ai/web), and [Canvas host](https://docs..ai/platforms/mac/canvas#canvas-a2ui).
- [CLI surface](https://docs..ai/tools/agent-send): gateway, agent, send, [wizard](https://docs..ai/start/wizard), and [doctor](https://docs..ai/gateway/doctor).
- [Pi agent runtime](https://docs..ai/concepts/agent) in RPC mode with tool streaming and block streaming.
- [Session model](https://docs..ai/concepts/session): `main` for direct chats, group isolation, activation modes, queue modes, reply-back. Group rules: [Groups](https://docs..ai/concepts/groups).
- [Media pipeline](https://docs..ai/nodes/images): images/audio/video, transcription hooks, size caps, temp file lifecycle. Audio details: [Audio](https://docs..ai/nodes/audio).
...
- [Group routing](https://docs..ai/concepts/group-messages): mention gating, reply tags, per-channel chunking and routing. Channel rules: [Channels](https://docs..ai/channels).

### Apps + nodes

- [macOS app](https://docs..ai/platforms/macos): menu bar control plane, [Voice Wake](https://docs..ai/nodes/voicewake)/PTT, [Talk Mode](https://docs..ai/nodes/talk) overlay, [WebChat](https://docs..ai/web/webchat), debug tools, [remote gateway](https://docs..ai/gateway/remote) control.
- [iOS node](https://docs..ai/platforms/ios): [Canvas](https://docs..ai/platforms/mac/canvas), [Voice Wake](https://docs..ai/nodes/voicewake), [Talk Mode](https://docs..ai/nodes/talk), camera, screen recording, Bonjour pairing.
- [Android node](https://docs..ai/platforms/android): [Canvas](https://docs..ai/platforms/mac/canvas), [Talk Mode](https://docs..ai/nodes/talk), camera, screen recording, optional SMS.
- [macOS node mode](https://docs..ai/nodes): system.run/notify + canvas/camera exposure.

### Tools + automation

- [Browser control](https://docs..ai/tools/browser): dedicated  Chrome/Chromium, snapshots, actions, uploads, profiles.
- [Canvas](https://docs..ai/platforms/mac/canvas): [A2UI](https://docs..ai/platforms/mac/canvas#canvas-a2ui) push/reset, eval, snapshot.
- [Nodes](https://docs..ai/nodes): camera snap/clip, screen record, [location.get](https://docs..ai/nodes/location-command), notifications.
- [Cron + wakeups](https://docs..ai/automation/cron-jobs); [webhooks](https://docs..ai/automation/webhook); [Gmail Pub/Sub](https://docs..ai/automation/gmail-pubsub).
- [Skills platform](https://docs..ai/tools/skills): bundled, managed, and workspace skills with install gating + UI.

### Runtime + safety

- [Channel routing](https://docs..ai/concepts/channel-routing), [retry policy](https://docs..ai/concepts/retry), and [streaming/chunking](https://docs..ai/concepts/streaming).
- [Presence](https://docs..ai/concepts/presence), [typing indicators](https://docs..ai/concepts/typing-indicators), and [usage tracking](https://docs..ai/concepts/usage-tracking).
- [Models](https://docs..ai/concepts/models), [model failover](https://docs..ai/concepts/model-failover), and [session pruning](https://docs..ai/concepts/session-pruning).
- [Security](https://docs..ai/gateway/security) and [troubleshooting](https://docs..ai/channels/troubleshooting).

### Ops + packaging

- [Control UI](https://docs..ai/web) + [WebChat](https://docs..ai/web/webchat) served directly from the Gateway.
- [Tailscale Serve/Funnel](https://docs..ai/gateway/tailscale) or [SSH tunnels](https://docs..ai/gateway/remote) with token/password auth.
- [Nix mode](https://docs..ai/install/nix) for declarative config; [Docker](https://docs..ai/install/docker)-based installs.
- [Doctor](https://docs..ai/gateway/doctor) migrations, [logging](https://docs..ai/logging).
...
- **[Gateway WebSocket network](https://docs..ai/concepts/architecture)** â€” single WS control plane for clients, tools, and events (plus ops: [Gateway runbook](https://docs..ai/gateway)).
- **[Tailscale exposure](https://docs..ai/gateway/tailscale)** â€” Serve/Funnel for the Gateway dashboard + WS (remote access: [Remote](https://docs..ai/gateway/remote)).
- **[Browser control](https://docs..ai/tools/browser)** â€” â€‘managed Chrome/Chromium with CDP control.
- **[Canvas + A2UI](https://docs..ai/platforms/mac/canvas)** â€” agentâ€‘driven visual workspace (A2UI host: [Canvas/A2UI](https://docs..ai/platforms/mac/canvas#canvas-a2ui)).
- **[Voice Wake](https://docs..ai/nodes/voicewake) + [Talk Mode](https://docs..ai/nodes/talk)** â€” alwaysâ€‘on speech and continuous conversation.
- **[Nodes](https://docs..ai/nodes)** â€” Canvas, camera snap/clip, screen record, `location.get`, notifications, plus macOSâ€‘only `system.run`/`system.notify`.

## Tailscale access (Gateway dashboard)

 can auto-configure Tailscale **Serve** (tailnet-only) or **Funnel** (public) while the Gateway stays bound to loopback. Configure `gateway.tailscale.mode`:
...
- `gateway.bind` must stay `loopback` when Serve/Funnel is enabled ( enforces this).
- Serve can be forced to require a password by setting `gateway.auth.mode: "password"` or `gateway.auth.allowTailscale: false`.
- Funnel refuses to start unless `gateway.auth.mode: "password"` is set.
- Optional: `gateway.tailscale.resetOnExit` to undo Serve/Funnel on shutdown.

Details: [Tailscale guide](https://docs..ai/gateway/tailscale) Â· [Web surfaces](https://docs..ai/web)
...
Details: [Remote access](https://docs..ai/gateway/remote) Â· [Nodes](https://docs..ai/nodes) Â· [Security](https://docs..ai/gateway/security)
...
Details: [Nodes](https://docs..ai/nodes) Â· [macOS app](https://docs..ai/platforms/macos) Â· [Gateway protocol](https://docs..ai/concepts/architecture)
...
Details: [Session tools](https://docs..ai/concepts/session-tool)
...
- Controlled via ` nodes â€¦`.

Runbook: [iOS connect](https://docs..ai/platforms/ios).

### Android node (optional)

- Pairs via the same Bridge + pairing flow as iOS.
- Exposes Canvas, Camera, and Screen capture commands.
- Runbook: [Android connect](https://docs..ai/platforms/android).

## Agent workspace + skills

- Workspace root: `~/./workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/./workspace/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/./.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs..ai/gateway/configuration)
...
Details: [Security guide](https://docs..ai/gateway/security) Â· [Docker + sandboxing](https://docs..ai/install/docker) Â· [Sandbox config](https://docs..ai/gateway/configuration)

### [WhatsApp](https://docs..ai/channels/whatsapp)

- Link the device: `pnpm  channels login` (stores creds in `~/./credentials`).
- Allowlist who can talk to the assistant via `channels.whatsapp.allowFrom`.
- If `channels.whatsapp.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Telegram](https://docs..ai/channels/telegram)
...
### [Slack](https://docs..ai/channels/slack)

- Set `SLACK_BOT_TOKEN` + `SLACK_APP_TOKEN` (or `channels.slack.botToken` + `channels.slack.appToken`).

### [Discord](https://docs..ai/channels/discord)
...
### [Signal](https://docs..ai/channels/signal)

- Requires `signal-cli` and a `channels.signal` config section.

### [BlueBubbles (iMessage)](https://docs..ai/channels/bluebubbles)

- **Recommended** iMessage integration.
- Configure `channels.bluebubbles.serverUrl` + `channels.bluebubbles.password` and a webhook (`channels.bluebubbles.webhookPath`).
- The BlueBubbles server runs on macOS; the Gateway can run on macOS or elsewhere.

### [iMessage (legacy)](https://docs..ai/channels/imessage)

- Legacy macOS-only integration via `imsg` (Messages must be signed in).
- If `channels.imessage.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Microsoft Teams](https://docs..ai/channels/msteams)

- Configure a Teams app + Bot Framework, then add a `msteams` config section.
- Allowlist who can talk via `msteams.allowFrom`; group access via `msteams.groupAllowFrom` or `msteams.groupPolicy: "open"`.

### [WebChat](https://docs..ai/web/webchat)
...
- [Start with the docs index for navigation and â€œwhatâ€™s where.â€](https://docs..ai)
- [Read the architecture overview for the gateway + protocol model.](https://docs..ai/concepts/architecture)
- [Use the full configuration reference when you need every key and example.](https://docs..ai/gateway/configuration)
- [Run the Gateway by the book with the operational runbook.](https://docs..ai/gateway)
- [Learn how the Control UI/Web surfaces work and how to expose them safely.](https://docs..ai/web)
- [Understand remote access over SSH tunnels or tailnets.](https://docs..ai/gateway/remote)
- [Follow the onboarding wizard flow for a guided setup.](https://docs..ai/start/wizard)
- [Wire external triggers via the webhook surface.](https://docs..ai/automation/webhook)
- [Set up Gmail Pub/Sub triggers.](https://docs..ai/automation/gmail-pubsub)
- [Learn the macOS menu bar companion details.](https://docs..ai/platforms/mac/menu-bar)
- [Platform guides: Windows (WSL2)](https://docs..ai/platforms/windows), [Linux](https://docs..ai/platforms/linux), [macOS](https://docs..ai/platforms/macos), [iOS](https://docs..ai/platforms/ios), [Android](https://docs..ai/platforms/android)
- [Debug common failures with the troubleshooting guide.](https://docs..ai/channels/troubleshooting)
- [Review security guidance before exposing anything.](https://docs..ai/gateway/security)

## Advanced docs (discovery + control)

- [Discovery + transports](https://docs..ai/gateway/discovery)
- [Bonjour/mDNS](https://docs..ai/gateway/bonjour)
- [Gateway pairing](https://docs..ai/gateway/pairing)
- [Remote gateway README](https://docs..ai/gateway/remote-gateway-readme)
- [Control UI](https://docs..ai/web/control-ui)
- [Dashboard](https://docs..ai/web/dashboard)

## Operations & troubleshooting

- [Health checks](https://docs..ai/gateway/health)
- [Gateway lock](https://docs..ai/gateway/gateway-lock)
- [Background process](https://docs..ai/gateway/background-process)
- [Browser troubleshooting (Linux)](https://docs..ai/tools/browser-linux-troubleshooting)
- [Logging](https://docs..ai/logging)

## Deep dives

- [Agent loop](https://docs..ai/concepts/agent-loop)
- [Presence](https://docs..ai/concepts/presence)
- [TypeBox schemas](https://docs..ai/concepts/typebox)
- [RPC adapters](https://docs..ai/reference/rpc)
- [Queue](https://docs..ai/concepts/queue)

## Workspace & skills

- [Skills config](https://docs..ai/tools/skills-config)
- [Default AGENTS](https://docs..ai/reference/AGENTS.default)
- [Templates: AGENTS](https://docs..ai/reference/templates/AGENTS)
- [Templates: BOOTSTRAP](https://docs..ai/reference/templates/BOOTSTRAP)
- [Templates: IDENTITY](https://docs..ai/reference/templates/IDENTITY)
- [Templates: SOUL](https://docs..ai/reference/templates/SOUL)
- [Templates: TOOLS](https://docs..ai/reference/templates/TOOLS)
- [Templates: USER](https://docs..ai/reference/templates/USER)

## Platform internals

- [macOS dev setup](https://docs..ai/platforms/mac/dev-setup)
- [macOS menu bar](https://docs..ai/platforms/mac/menu-bar)
- [macOS voice wake](https://docs..ai/platforms/mac/voicewake)
- [iOS node](https://docs..ai/platforms/ios)
- [Android node](https://docs..ai/platforms/android)
- [Windows (WSL2)](https://docs..ai/platforms/windows)
- [Linux app](https://docs..ai/platforms/linux)

## Email hooks (Gmail)

- [docs..ai/gmail-pubsub](https://docs..ai/automation/gmail-pubsub)

## Molty

 was built for **Molty**, a space lobster AI assistant. ðŸ¦ž
