...
# Streaming + chunking
 ...
 has two separate â€œstreamingâ€ layers:
...
When block streaming is enabled,  can **merge consecutive block chunks**
...
When draft streaming is active,  disables block streaming for that reply to avoid double-streaming.
