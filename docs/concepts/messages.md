...
This page ties together how  handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects.  keeps a
...
## Inbound bodies and history context
 ...
 separates the **prompt body** from the **command body**:
...
## Reasoning visibility and tokens
 ...
 can expose or hide model reasoning:
