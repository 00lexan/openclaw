---
title: "Showcase"
description: "Real-world  projects from the community"
summary: "Community-built projects and integrations powered by "
---

# Showcase

Real projects from the community. See what people are building with .

<Info>
**Want to be featured?** Share your project in [#showcase on Discord](https://discord.gg/clawd) or [tag @ on X](https://x.com/).
</Info>
...
>
  <iframe
    ...
    title=": The self-hosted AI that Siri should have been (Full setup)"
...
OpenCode finishes the change â†’ opens a PR â†’  reviews the diff and replies in Telegram with â€œminor suggestionsâ€ plus a clear merge verdict (including critical fixes to apply first).
...
Asked â€œRobbyâ€ (@) for a local wine cellar skill. It requests a sample CSV export + where to store it, then builds/tests the skill fast (962 bottles in the example).

  <img src="/assets/showcase/wine-cellar-skill.jpg" alt=" building a local wine cellar skill from CSV" />
</Card>
...
Upload to Cloudflare R2/S3 and generate secure presigned download links. Perfect for remote  instances.
</Card>
...
CLI for Linear that integrates with agentic workflows (Claude Code, ). Manage issues, projects, and workflows from the terminal. First external PR merged!
</Card>
...
Claude Code discovered and confirmed the purifier controls, then  takes over to manage room air quality.

  <img src="/assets/showcase/winix-air-purifier.jpg" alt="Winix air purifier control via " />
</Card>

<Card title="Pretty Sky Camera Shots" icon="camera" href="https://x.com/signalgaining/status/2010523120604746151">
  **@signalgaining** â€¢ `automation` `camera` `skill` `images`

Triggered by a roof camera: ask  to snap a sky photo whenever it looks pretty â€” it designed a skill and took the shot.

  <img src="/assets/showcase/roof-camera-sky.jpg" alt="Roof camera sky snapshot captured by " />
</Card>

<Card title="Visual Morning Briefing Scene" icon="robot" href="https://x.com/buddyhadry/status/2010005331925954739">
  **@buddyhadry** â€¢ `automation` `briefing` `images` `telegram`

A scheduled prompt generates a single "scene" image each morning (weather, tasks, date, favorite post/quote) via a  persona.
</Card>
...
<Card title="Jira Skill Builder" icon="diagram-project" href="https://x.com/jdrhyne/status/2008336434827002232">
 ...
 connected to Jira, then generated a new skill on the fly (before it existed on ClawHub).
</Card>

<Card title="Todoist Skill via Telegram" icon="list-check" href="https://x.com/iamsubhrajyoti/status/2009949389884920153">
  **@iamsubhrajyoti** â€¢ `automation` `todoist` `skill` `telegram`

Automated Todoist tasks and had  generate the skill directly in Telegram chat.
</Card>
...
<Card title="xuezh Chinese Learning" icon="language" href="https://github.com/joshp123/xuezh">
  **@joshp123** â€¢ `learning` `voice` `skill`
  ...
  Chinese learning engine with pronunciation feedback and study flows via .
...
<Card title="Clawdia Phone Bridge" icon="phone" href="https://github.com/alejandroOPI/clawdia-bridge">
  **@alejandroOPI** â€¢ `voice` `vapi` `bridge`
  ...
  Vapi voice assistant â†”  HTTP bridge. Near real-time phone calls with your agent.
</Card>
...
<Card title="Home Assistant Add-on" icon="home" href="https://github.com/ngutman/-ha-addon">
  **@ngutman** â€¢ `homeassistant` `docker` `raspberry-pi`
  
   gateway running on Home Assistant OS with SSH tunnel support and persistent state.
</Card>
...
<Card title="Nix Packaging" icon="snowflake" href="https://github.com//nix-">
  **@** â€¢ `nix` `packaging` `deployment`
  
  Batteries-included nixified  configuration for reproducible deployments.
</Card>
...
<Card title="GoHome Automation" icon="house-signal" href="https://github.com/joshp123/gohome">
  **@joshp123** â€¢ `home` `nix` `grafana`
  ...
  Nix-native home automation with  as the interface, plus beautiful Grafana dashboards.
...
<Card title="StarSwap Marketplace" icon="star" href="https://star-swap.com/">
  **Community** â€¢ `marketplace` `astronomy` `webapp`
  ...
  Full astronomy gear marketplace. Built with/around the  ecosystem.
</Card>
...
<Steps>
  <Step title="Share It">
    Post in [#showcase on Discord](https://discord.gg/clawd) or [tweet @](https://x.com/)
  </Step>
