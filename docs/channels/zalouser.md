...
- Install via CLI: ` plugins install @/zalouser`
- Or from a source checkout: ` plugins install ./extensions/zalouser`
...
- On startup,  resolves group/user names in allowlists to IDs and logs the mapping; unresolved entries are kept as typed.
