...
- Install via CLI: ` plugins install @/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: ` plugins install ./extensions/zalo`
   - From npm (if published): ` plugins install @/zalo`
...
| Groups          | âŒ Coming soon (per Zalo docs) |
...
- Example: ` message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: ` channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: ` logs --follow`
