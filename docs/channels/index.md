---
summary: "Messaging platforms  can connect to"
read_when:
  - You want to choose a chat channel for 
...
# Chat Channels
 ...
 can talk to you on any chat app you already use. Each channel connects via the Gateway.
...
- Channels can run simultaneously; configure multiple and  will route per chat.
