...
é€šè¿‡ IRC è¿žæŽ¥æ”¯æŒ Twitch èŠå¤©ã€‚ ä»¥ Twitch ç”¨æˆ·ï¼ˆæœºå™¨äººè´¦æˆ·ï¼‰èº«ä»½è¿žæŽ¥ï¼Œåœ¨é¢‘é“ä¸­æŽ¥æ”¶å’Œå‘é€æ¶ˆæ¯ã€‚
...
4. é…ç½®ä»¤ç‰Œï¼š
   - çŽ¯å¢ƒå˜é‡ï¼š`_TWITCH_ACCESS_TOKEN=...`ï¼ˆä»…é™é»˜è®¤è´¦æˆ·ï¼‰
...
```json5
{
  channels: {
    twitch: {
      enabled: true,
      username: "", // æœºå™¨äººçš„ Twitch è´¦æˆ·
      accessToken: "oauth:abc123...", // OAuth Access Tokenï¼ˆæˆ–ä½¿ç”¨ _TWITCH_ACCESS_TOKEN çŽ¯å¢ƒå˜é‡ï¼‰
