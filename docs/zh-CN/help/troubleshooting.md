...
ä½ ä¹Ÿå¯ä»¥è®¾ç½® `_VERBOSE=1` ä»£æ›¿æ ‡å¿—ã€‚
...
### `docs..ai` æ˜¾ç¤º SSL é”™è¯¯ï¼ˆComcast/Xfinityï¼‰

ä¸€äº› Comcast/Xfinity è¿žæŽ¥é€šè¿‡ Xfinity Advanced Security é˜»æ­¢ `docs..ai`ã€‚
ç¦ç”¨ Advanced Security æˆ–å°† `docs..ai` æ·»åŠ åˆ°å…è®¸åˆ—è¡¨ï¼Œç„¶åŽé‡è¯•ã€‚
...
- æ£€æŸ¥å…è®¸åˆ—è¡¨ï¼š` config get agents.defaults.models`
