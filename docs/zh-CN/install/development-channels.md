...
å½“ä½ ä½¿ç”¨ `--channel` **æ˜¾å¼**åˆ‡æ¢æ¸ é“æ—¶ï¼Œ è¿˜ä¼šå¯¹é½å®‰è£…æ–¹å¼ï¼š

- `dev` ç¡®ä¿æœ‰ä¸€ä¸ª git checkoutï¼ˆé»˜è®¤ `~/`ï¼Œå¯é€šè¿‡ `_GIT_DIR` è¦†ç›–ï¼‰ï¼Œ
...
å½“ä½ ä½¿ç”¨ ` update` åˆ‡æ¢æ¸ é“æ—¶ï¼Œ è¿˜ä¼šåŒæ­¥æ’ä»¶æ¥æºï¼š
