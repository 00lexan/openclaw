...
summary: ä½¿ç”¨ Ansibleã€Tailscale VPN å’Œé˜²ç«å¢™éš”ç¦»è¿›è¡Œè‡ªåŠ¨åŒ–ã€åŠ å›ºçš„  å®‰è£…
title: Ansible
x-i18n:
...
å°†  éƒ¨ç½²åˆ°ç”Ÿäº§æœåŠ¡å™¨çš„æŽ¨èæ–¹å¼æ˜¯é€šè¿‡ **[-ansible](https://github.com//-ansible)** â€” ä¸€ä¸ªå®‰å…¨ä¼˜å…ˆæž¶æž„çš„è‡ªåŠ¨åŒ–å®‰è£…ç¨‹åºã€‚
...
> **ðŸ“¦ å®Œæ•´æŒ‡å—ï¼š[github.com//-ansible](https://github.com//-ansible)**
>
> -ansible ä»“åº“æ˜¯ Ansible éƒ¨ç½²çš„æƒå¨æ¥æºã€‚æœ¬é¡µæ˜¯å¿«é€Ÿæ¦‚è¿°ã€‚
...
5. ****ï¼ˆåŸºäºŽä¸»æœºï¼Œéžå®¹å™¨åŒ–ï¼‰
...
å®‰è£…å®ŒæˆåŽï¼Œåˆ‡æ¢åˆ°  ç”¨æˆ·ï¼š
...
æ²™ç®±é…ç½®å‚è§[å¤šæ™ºèƒ½ä½“æ²™ç®±ä¸Žå·¥å…·](/multi-agent-sandbox-tools)ã€‚
...
# æˆ–ç›´æŽ¥è¿è¡Œï¼ˆç„¶åŽæ‰‹åŠ¨æ‰§è¡Œ /tmp/-setup.shï¼‰
# ansible-playbook playbook.yml --ask-become-pass
```

## æ›´æ–° 

Ansible å®‰è£…ç¨‹åºè®¾ç½®  ä¸ºæ‰‹åŠ¨æ›´æ–°ã€‚æ ‡å‡†æ›´æ–°æµç¨‹å‚è§[æ›´æ–°](/install/updating)ã€‚
...
- [å®‰å…¨æž¶æž„](https://github.com//-ansible/blob/main/docs/security.md)
- [æŠ€æœ¯è¯¦æƒ…](https://github.com//-ansible/blob/main/docs/architecture.md)
- [æ•…éšœæŽ’é™¤æŒ‡å—](https://github.com//-ansible/blob/main/docs/troubleshooting.md)

## ç›¸å…³å†…å®¹

- [-ansible](https://github.com//-ansible) â€” å®Œæ•´éƒ¨ç½²æŒ‡å—
- [Docker](/install/docker) â€” å®¹å™¨åŒ– Gateway ç½‘å…³è®¾ç½®
- [æ²™ç®±éš”ç¦»](/gateway/sandboxing) â€” æ™ºèƒ½ä½“æ²™ç®±é…ç½®
- [å¤šæ™ºèƒ½ä½“æ²™ç®±ä¸Žå·¥å…·](/multi-agent-sandbox-tools) â€” æ¯ä¸ªæ™ºèƒ½ä½“çš„éš”ç¦»
