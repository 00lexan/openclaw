---
read_when:
  - ä½ æƒ³åœ¨  ä¸­ä½¿ç”¨ MiniMax æ¨¡åž‹
  - ä½ éœ€è¦ MiniMax è®¾ç½®æŒ‡å—
summary: åœ¨  ä¸­ä½¿ç”¨ MiniMax M2.1
title: MiniMax
x-i18n:
...
```bash
 plugins enable minimax-portal-auth  # å¦‚æžœå·²åŠ è½½åˆ™è·³è¿‡
 gateway restart  # å¦‚æžœ Gateway ç½‘å…³å·²åœ¨è¿è¡Œåˆ™é‡å¯
 onboard --auth-choice minimax-portal
```
...
è¯¦æƒ…å‚è§ [MiniMax OAuth æ’ä»¶ README](https://github.com///tree/main/extensions/minimax-portal-auth)ã€‚
...
- ä½¿ç”¨ ` models list` å’Œ ` models set minimax/MiniMax-M2.1` åˆ‡æ¢æ¨¡åž‹ã€‚
...
- è¿è¡Œ ` configure` å¹¶é€‰æ‹© **MiniMax M2.1**ï¼Œæˆ–
