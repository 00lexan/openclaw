...
summary: ç¤¾åŒºæž„å»ºçš„åŸºäºŽ  çš„é¡¹ç›®å’Œé›†æˆ
title: æ¡ˆä¾‹å±•ç¤º
x-i18n:
...
æ¥è‡ªç¤¾åŒºçš„çœŸå®žé¡¹ç›®ã€‚çœ‹çœ‹å¤§å®¶æ­£åœ¨ç”¨  æž„å»ºä»€ä¹ˆã€‚

<Info>
**æƒ³è¦å±•ç¤ºä½ çš„é¡¹ç›®ï¼Ÿ** åœ¨ [Discord çš„ #showcase é¢‘é“](https://discord.gg/clawd) åˆ†äº«æˆ–åœ¨ [X ä¸Š @](https://x.com/)ã€‚
</Info>
...
OpenCode å®Œæˆæ›´æ”¹ â†’ æ‰“å¼€ PR â†’  å®¡æŸ¥å·®å¼‚å¹¶åœ¨ Telegram ä¸­å›žå¤"å°å»ºè®®"åŠ ä¸Šæ˜Žç¡®çš„åˆå¹¶å†³å®šï¼ˆåŒ…æ‹¬éœ€è¦å…ˆåº”ç”¨çš„å…³é”®ä¿®å¤ï¼‰ã€‚
...
å‘"Robby"ï¼ˆ@ï¼‰è¯·æ±‚ä¸€ä¸ªæœ¬åœ°é…’çª– skillã€‚å®ƒè¯·æ±‚ä¸€ä¸ªç¤ºä¾‹ CSV å¯¼å‡º + å­˜å‚¨ä½ç½®ï¼Œç„¶åŽå¿«é€Ÿæž„å»º/æµ‹è¯•è¯¥ skillï¼ˆç¤ºä¾‹ä¸­æœ‰ 962 ç“¶é…’ï¼‰ã€‚
...
è·¨ Agentsã€Claudeã€Codex å’Œ  ç®¡ç† skills/å‘½ä»¤çš„æ¡Œé¢åº”ç”¨ã€‚
...
ä¸Šä¼ åˆ° Cloudflare R2/S3 å¹¶ç”Ÿæˆå®‰å…¨çš„é¢„ç­¾åä¸‹è½½é“¾æŽ¥ã€‚éžå¸¸é€‚åˆè¿œç¨‹  å®žä¾‹ã€‚
</Card>
...
ä¸€ä¸ª Gateway ç½‘å…³ä¸‹çš„ 14+ æ™ºèƒ½ä½“ï¼ŒOpus 4.5 ç¼–æŽ’å™¨å°†ä»»åŠ¡å§”æ´¾ç»™ Codex å·¥ä½œè€…ã€‚å…¨é¢çš„[æŠ€æœ¯æ–‡ç« ](https://github.com/adam91holt/orchestrated-ai-articles)æ¶µç›–æ¢¦ä¹‹é˜Ÿé˜µå®¹ã€æ¨¡åž‹é€‰æ‹©ã€æ²™ç®±éš”ç¦»ã€webhookã€å¿ƒè·³å’Œå§”æ´¾æµç¨‹ã€‚ç”¨äºŽæ™ºèƒ½ä½“æ²™ç®±éš”ç¦»çš„ [Clawdspace](https://github.com/adam91holt/clawdspace)ã€‚[åšå®¢æ–‡ç« ](https://adams-ai-journey.ghost.io/2026-the-year-of-the-orchestrator/)ã€‚
</Card>

<Card title="Linear CLI" icon="terminal" href="https://github.com/Finesssee/linear-cli">
  **@NessZerra** â€¢ `devtools` `linear` `cli` `issues`

ä¸Žæ™ºèƒ½ä½“å·¥ä½œæµï¼ˆClaude Codeã€ï¼‰é›†æˆçš„ Linear CLIã€‚ä»Žç»ˆç«¯ç®¡ç†é—®é¢˜ã€é¡¹ç›®å’Œå·¥ä½œæµã€‚é¦–ä¸ªå¤–éƒ¨ PR å·²åˆå¹¶ï¼
</Card>
...
Claude Code å‘çŽ°å¹¶ç¡®è®¤äº†å‡€åŒ–å™¨æŽ§åˆ¶ï¼Œç„¶åŽ  æŽ¥ç®¡æ¥ç®¡ç†æˆ¿é—´ç©ºæ°”è´¨é‡ã€‚
...
ç”±å±‹é¡¶æ‘„åƒå¤´è§¦å‘ï¼šè®©  åœ¨å¤©ç©ºçœ‹èµ·æ¥å¾ˆç¾Žçš„æ—¶å€™æ‹ä¸€å¼ ç…§ç‰‡â€”â€”å®ƒè®¾è®¡äº†ä¸€ä¸ª skill å¹¶æ‹æ‘„äº†ç…§ç‰‡ã€‚
...
å®šæ—¶æç¤ºæ¯å¤©æ—©ä¸Šé€šè¿‡  è§’è‰²ç”Ÿæˆä¸€å¼ "åœºæ™¯"å›¾ç‰‡ï¼ˆå¤©æ°”ã€ä»»åŠ¡ã€æ—¥æœŸã€å–œæ¬¢çš„å¸–å­/å¼•è¨€ï¼‰ã€‚
</Card>
...
<Card title="Jira Skill æž„å»ºå™¨" icon="diagram-project" href="https://x.com/jdrhyne/status/2008336434827002232">
 ...
 è¿žæŽ¥åˆ° Jiraï¼Œç„¶åŽå³æ—¶ç”Ÿæˆä¸€ä¸ªæ–°çš„ skillï¼ˆåœ¨å®ƒå‡ºçŽ°åœ¨ ClawHub ä¹‹å‰ï¼‰ã€‚
</Card>
...
è‡ªåŠ¨åŒ– Todoist ä»»åŠ¡ï¼Œå¹¶è®©  ç›´æŽ¥åœ¨ Telegram èŠå¤©ä¸­ç”Ÿæˆ skillã€‚
</Card>
...
<Card title="xuezh ä¸­æ–‡å­¦ä¹ " icon="language" href="https://github.com/joshp123/xuezh">
  **@joshp123** â€¢ `learning` `voice` `skill`
  ...
  é€šè¿‡  å®žçŽ°å¸¦æœ‰å‘éŸ³åé¦ˆå’Œå­¦ä¹ æµç¨‹çš„ä¸­æ–‡å­¦ä¹ å¼•æ“Žã€‚
...
<Card title="Clawdia ç”µè¯æ¡¥æŽ¥" icon="phone" href="https://github.com/alejandroOPI/clawdia-bridge">
  **@alejandroOPI** â€¢ `voice` `vapi` `bridge`
  ...
  Vapi è¯­éŸ³åŠ©æ‰‹ â†”  HTTP æ¡¥æŽ¥ã€‚ä¸Žä½ çš„æ™ºèƒ½ä½“è¿›è¡Œè¿‘å®žæ—¶ç”µè¯é€šè¯ã€‚
</Card>
...
<Card title="Home Assistant æ’ä»¶" icon="home" href="https://github.com/ngutman/-ha-addon">
  **@ngutman** â€¢ `homeassistant` `docker` `raspberry-pi`
  
  åœ¨ Home Assistant OS ä¸Šè¿è¡Œçš„  Gateway ç½‘å…³ï¼Œæ”¯æŒ SSH éš§é“å’ŒæŒä¹…çŠ¶æ€ã€‚
</Card>
...
<Card title="Nix æ‰“åŒ…" icon="snowflake" href="https://github.com//nix-">
  **@** â€¢ `nix` `packaging` `deployment`
  
  å¼€ç®±å³ç”¨çš„ nixified  é…ç½®ï¼Œç”¨äºŽå¯å¤çŽ°çš„éƒ¨ç½²ã€‚
</Card>
...
<Card title="GoHome è‡ªåŠ¨åŒ–" icon="house-signal" href="https://github.com/joshp123/gohome">
  **@joshp123** â€¢ `home` `nix` `grafana`
  ...
  Nix åŽŸç”Ÿå®¶åº­è‡ªåŠ¨åŒ–ï¼Œä»¥  ä½œä¸ºç•Œé¢ï¼ŒåŠ ä¸Šæ¼‚äº®çš„ Grafana ä»ªè¡¨æ¿ã€‚
...
<Card title="StarSwap å¸‚åœº" icon="star" href="https://star-swap.com/">
  **ç¤¾åŒº** â€¢ `marketplace` `astronomy` `webapp`
  ...
  å®Œæ•´çš„å¤©æ–‡è®¾å¤‡å¸‚åœºã€‚å›´ç»•  ç”Ÿæ€ç³»ç»Ÿæž„å»ºã€‚
</Card>
...
<Steps>
  <Step title="åˆ†äº«å®ƒ">
    åœ¨ [Discord çš„ #showcase é¢‘é“](https://discord.gg/clawd) å‘å¸ƒæˆ–åœ¨ [Twitter ä¸Š @](https://x.com/)
  </Step>
