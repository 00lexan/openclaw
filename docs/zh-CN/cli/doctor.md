...
summary: "` doctor` çš„ CLI å‚è€ƒï¼ˆå¥åº·æ£€æŸ¥ + å¼•å¯¼å¼ä¿®å¤ï¼‰"
title: doctor
x-i18n:
...
- `--fix`ï¼ˆ`--repair` çš„åˆ«åï¼‰ä¼šå°†å¤‡ä»½å†™å…¥ `~/./.json.bak`ï¼Œå¹¶åˆ é™¤æœªçŸ¥çš„é…ç½®é”®ï¼ŒåŒæ—¶åˆ—å‡ºæ¯ä¸ªåˆ é™¤é¡¹ã€‚

## macOSï¼š`launchctl` çŽ¯å¢ƒå˜é‡è¦†ç›–

å¦‚æžœä½ ä¹‹å‰è¿è¡Œè¿‡ `launchctl setenv _GATEWAY_TOKEN ...`ï¼ˆæˆ– `...PASSWORD`ï¼‰ï¼Œè¯¥å€¼ä¼šè¦†ç›–ä½ çš„é…ç½®æ–‡ä»¶ï¼Œå¹¶å¯èƒ½å¯¼è‡´æŒç»­çš„"æœªæŽˆæƒ"é”™è¯¯ã€‚
