...
- å®Œæ•´æµ‹è¯•å¥—ä»¶ï¼ˆæµ‹è¯•é›†ã€å®žæ—¶æµ‹è¯•ã€Dockerï¼‰ï¼š[æµ‹è¯•](/testing)
...
è„šæœ¬ï¼š[`scripts/bench-model.ts`](https://github.com///blob/main/scripts/bench-model.ts)
...
æ­¤è„šæœ¬é€šè¿‡ä¼ªç»ˆç«¯é©±åŠ¨äº¤äº’å¼å‘å¯¼ï¼ŒéªŒè¯é…ç½®/å·¥ä½œåŒº/ä¼šè¯æ–‡ä»¶ï¼Œç„¶åŽå¯åŠ¨ Gateway ç½‘å…³å¹¶è¿è¡Œ ` health`ã€‚
