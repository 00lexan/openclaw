...
å½“ä½ éœ€è¦åˆ‡æ¢ä¸å¸¸ç”¨çš„è®¾ç½®è€Œä¸ç¼–è¾‘ `.json` æ—¶ï¼Œè¿™éžå¸¸æ–¹ä¾¿ã€‚
...
- **å…¨å±€ `--dev`ï¼ˆé…ç½®æ–‡ä»¶ï¼‰ï¼š** å°†çŠ¶æ€éš”ç¦»åˆ° `~/.-dev` ä¸‹ï¼Œå¹¶å°† Gateway ç½‘å…³ç«¯å£é»˜è®¤ä¸º `19001`ï¼ˆæ´¾ç”Ÿç«¯å£éšä¹‹ç§»åŠ¨ï¼‰ã€‚
...
å¦‚æžœä½ è¿˜æ²¡æœ‰å…¨å±€å®‰è£…ï¼Œè¯·é€šè¿‡ `pnpm  ...` è¿è¡Œ CLIã€‚
...
1. **é…ç½®æ–‡ä»¶éš”ç¦»**ï¼ˆå…¨å±€ `--dev`ï¼‰
   ...
   - `_GATEWAY_PORT=19001`ï¼ˆæµè§ˆå™¨/ç”»å¸ƒç›¸åº”ç§»åŠ¨ï¼‰
...
2. **Dev å¼•å¯¼**ï¼ˆ`gateway --dev`ï¼‰
   ...
   - åœ¨ dev æ¨¡å¼ä¸‹è·³è¿‡æ¸ é“æä¾›å•†ï¼ˆ`_SKIP_CHANNELS=1`ï¼‰ã€‚
...
## åŽŸå§‹æµæ—¥å¿—ï¼ˆï¼‰
 ...
 å¯ä»¥åœ¨ä»»ä½•è¿‡æ»¤/æ ¼å¼åŒ–ä¹‹å‰è®°å½•**åŽŸå§‹åŠ©æ‰‹æµ**ã€‚
