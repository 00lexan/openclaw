---
read_when:
  - ä½ æƒ³è®©  åœ¨äº‘ VPS ä¸Š 24/7 è¿è¡Œï¼ˆè€Œä¸æ˜¯ä½ çš„ç¬”è®°æœ¬ç”µè„‘ï¼‰
  - ä½ æƒ³åœ¨è‡ªå·±çš„ VPS ä¸Šè¿è¡Œç”Ÿäº§çº§ã€æ°¸ä¹…åœ¨çº¿çš„ Gateway ç½‘å…³
  - ä½ æƒ³å®Œå…¨æŽ§åˆ¶æŒä¹…åŒ–ã€äºŒè¿›åˆ¶æ–‡ä»¶å’Œé‡å¯è¡Œä¸º
  - ä½ åœ¨ Hetzner æˆ–ç±»ä¼¼æä¾›å•†ä¸Šç”¨ Docker è¿è¡Œ 
summary: åœ¨å»‰ä»·çš„ Hetzner VPSï¼ˆDockerï¼‰ä¸Š 24/7 è¿è¡Œ  Gateway ç½‘å…³ï¼Œå¸¦æŒä¹…çŠ¶æ€å’Œå†…ç½®äºŒè¿›åˆ¶æ–‡ä»¶
title: Hetzner
x-i18n:
...
# åœ¨ Hetzner ä¸Šè¿è¡Œ ï¼ˆDockerï¼Œç”Ÿäº§ VPS æŒ‡å—ï¼‰

## ç›®æ ‡

ä½¿ç”¨ Docker åœ¨ Hetzner VPS ä¸Šè¿è¡ŒæŒä¹…çš„  Gateway ç½‘å…³ï¼Œå¸¦æŒä¹…çŠ¶æ€ã€å†…ç½®äºŒè¿›åˆ¶æ–‡ä»¶å’Œå®‰å…¨çš„é‡å¯è¡Œä¸ºã€‚

å¦‚æžœä½ æƒ³è¦"çº¦ $5 å®žçŽ°  24/7"ï¼Œè¿™æ˜¯æœ€ç®€å•å¯é çš„è®¾ç½®ã€‚
...
- åœ¨ä¸»æœºä¸ŠæŒä¹…åŒ– `~/.` + `~/./workspace`ï¼ˆé‡å¯/é‡å»ºåŽä¿ç•™ï¼‰
...
## æŒä¹…åŒ–ä½ç½®ï¼ˆäº‹å®žæ¥æºï¼‰
 ...
 åœ¨ Docker ä¸­è¿è¡Œï¼Œä½† Docker ä¸æ˜¯äº‹å®žæ¥æºã€‚
...
| WhatsApp ä¼šè¯    | `/home/node/./`           | ä¸»æœºå·æŒ‚è½½    | ä¿ç•™äºŒç»´ç ç™»å½•              |
