...
- ç½‘ç»œè·¯å¾„ï¼š
  ...
  - é€šè¿‡å•æ’­ DNS-SD çš„ Tailnetï¼ˆç¤ºä¾‹åŸŸï¼š`.internal.`ï¼‰ï¼Œ**æˆ–**
...
Gateway ç½‘å…³åœ¨ `local.` ä¸Šå¹¿æ’­ `_-gw._tcp`ã€‚iOS åº”ç”¨ä¼šè‡ªåŠ¨åˆ—å‡ºè¿™äº›ã€‚

### Tailnetï¼ˆè·¨ç½‘ç»œï¼‰

å¦‚æžœ mDNS è¢«é˜»æ­¢ï¼Œä½¿ç”¨å•æ’­ DNS-SD åŒºåŸŸï¼ˆé€‰æ‹©ä¸€ä¸ªåŸŸï¼›ç¤ºä¾‹ï¼š`.internal.`ï¼‰å’Œ Tailscale åˆ†å‰² DNSã€‚
...
- Gateway ç½‘å…³ canvas ä¸»æœºæœåŠ¡äºŽ `/____/canvas/` å’Œ `/____/a2ui/`ã€‚
...
- é…å¯¹æç¤ºä»Žæœªå‡ºçŽ°ï¼šè¿è¡Œ ` nodes pending` å¹¶æ‰‹åŠ¨æ‰¹å‡†ã€‚
