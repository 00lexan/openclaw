---
read_when:
  - åœ¨ Raspberry Pi ä¸Šè®¾ç½®  æ—¶
  - åœ¨ ARM è®¾å¤‡ä¸Šè¿è¡Œ  æ—¶
  - æž„å»ºä½Žæˆæœ¬å¸¸é©»ä¸ªäºº AI æ—¶
summary: åœ¨ Raspberry Pi ä¸Šè¿è¡Œ ï¼ˆä½Žæˆæœ¬è‡ªæ‰˜ç®¡è®¾ç½®ï¼‰
title: Raspberry Pi
x-i18n:
...
# åœ¨ Raspberry Pi ä¸Šè¿è¡Œ 

## ç›®æ ‡

åœ¨ Raspberry Pi ä¸Šè¿è¡ŒæŒä¹…ã€å¸¸é©»çš„  Gateway ç½‘å…³ï¼Œ**ä¸€æ¬¡æ€§æˆæœ¬çº¦ $35-80**ï¼ˆæ— æœˆè´¹ï¼‰ã€‚
...
å¤§å¤šæ•°  åŠŸèƒ½åœ¨ ARM64 ä¸Šå¯ç”¨ï¼Œä½†æŸäº›å¤–éƒ¨äºŒè¿›åˆ¶æ–‡ä»¶å¯èƒ½éœ€è¦ ARM æž„å»ºï¼š
...
- [Hetzner æŒ‡å—](/platforms/hetzner) â€” Docker è®¾ç½®
