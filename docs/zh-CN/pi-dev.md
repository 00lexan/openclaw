...
æœ¬æŒ‡å—æ€»ç»“äº†åœ¨  ä¸­å¼€å‘ Pi é›†æˆçš„åˆç†å·¥ä½œæµç¨‹ã€‚
...
- ç›´æŽ¥è§¦å‘æ™ºèƒ½ä½“ï¼š
  - `pnpm  agent --message "Hello" --thinking low`
...
çŠ¶æ€å­˜å‚¨åœ¨  çŠ¶æ€ç›®å½•ä¸‹ã€‚é»˜è®¤ä¸º `~/.`ã€‚å¦‚æžœè®¾ç½®äº† `_STATE_DIR`ï¼Œåˆ™ä½¿ç”¨è¯¥ç›®å½•ã€‚
