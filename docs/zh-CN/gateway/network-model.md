...
å¤§å¤šæ•°æ“ä½œé€šè¿‡ Gateway ç½‘å…³ï¼ˆ` gateway`ï¼‰è¿›è¡Œï¼Œå®ƒæ˜¯ä¸€ä¸ªé•¿æœŸè¿è¡Œçš„å•ä¸€è¿›ç¨‹ï¼Œè´Ÿè´£ç®¡ç†æ¸ é“è¿žæŽ¥å’Œ WebSocket æŽ§åˆ¶å¹³é¢ã€‚
...
- ä¼˜å…ˆä½¿ç”¨å›žçŽ¯åœ°å€ï¼šGateway ç½‘å…³çš„ WS é»˜è®¤ä¸º `ws://127.0.0.1:18789`ã€‚å³ä½¿æ˜¯å›žçŽ¯è¿žæŽ¥ï¼Œå‘å¯¼ä¹Ÿä¼šé»˜è®¤ç”Ÿæˆ gateway tokenã€‚è‹¥éœ€é€šè¿‡ tailnet è®¿é—®ï¼Œè¯·è¿è¡Œ ` gateway --bind tailnet --token ...`ï¼Œå› ä¸ºéžå›žçŽ¯ç»‘å®šå¿…é¡»ä½¿ç”¨ tokenã€‚
