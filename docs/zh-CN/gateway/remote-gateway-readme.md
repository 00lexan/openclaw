...
summary: .app è¿žæŽ¥è¿œç¨‹ Gateway ç½‘å…³çš„ SSH éš§é“è®¾ç½®
...
# ä½¿ç”¨è¿œç¨‹ Gateway ç½‘å…³è¿è¡Œ .app

.app ä½¿ç”¨ SSH éš§é“è¿žæŽ¥åˆ°è¿œç¨‹ Gateway ç½‘å…³ã€‚æœ¬æŒ‡å—å‘ä½ å±•ç¤ºå¦‚ä½•è®¾ç½®ã€‚
...
æ—§ç‰ˆæ³¨æ„äº‹é¡¹ï¼šå¦‚æžœå­˜åœ¨ä»»ä½•é—ç•™çš„ `com..ssh-tunnel` LaunchAgentï¼Œè¯·å°†å…¶åˆ é™¤ã€‚
...
.app è¿žæŽ¥åˆ°ä½ çš„å®¢æˆ·ç«¯æœºå™¨ä¸Šçš„ `ws://127.0.0.1:18789`ã€‚SSH éš§é“å°†è¯¥è¿žæŽ¥è½¬å‘åˆ°è¿è¡Œ Gateway ç½‘å…³çš„è¿œç¨‹æœºå™¨çš„ç«¯å£ 18789ã€‚
