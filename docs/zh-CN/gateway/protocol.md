...
Gateway ç½‘å…³ WS åè®®æ˜¯  çš„**å•ä¸€æŽ§åˆ¶å¹³é¢ + èŠ‚ç‚¹ä¼ è¾“**ã€‚æ‰€æœ‰å®¢æˆ·ç«¯ï¼ˆCLIã€Web UIã€macOS åº”ç”¨ã€iOS/Android èŠ‚ç‚¹ã€æ— å¤´èŠ‚ç‚¹ï¼‰éƒ½é€šè¿‡ WebSocket è¿žæŽ¥ï¼Œå¹¶åœ¨æ¡æ‰‹æ—¶å£°æ˜Žå…¶**è§’è‰²** + **ä½œç”¨åŸŸ**ã€‚
...
- å¦‚æžœè®¾ç½®äº† `_GATEWAY_TOKEN`ï¼ˆæˆ– `--token`ï¼‰ï¼Œ`connect.params.auth.token`
