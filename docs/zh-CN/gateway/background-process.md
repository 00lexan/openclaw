...
# åŽå° Exec + Process å·¥å…·
 ...
 é€šè¿‡ `exec` å·¥å…·è¿è¡Œ shell å‘½ä»¤ï¼Œå¹¶å°†é•¿æ—¶é—´è¿è¡Œçš„ä»»åŠ¡ä¿å­˜åœ¨å†…å­˜ä¸­ã€‚`process` å·¥å…·ç®¡ç†è¿™äº›åŽå°ä¼šè¯ã€‚
...
- `_BASH_PENDING_MAX_OUTPUT_CHARS`ï¼šæ¯ä¸ªæµçš„å¾…å¤„ç† stdout/stderr ä¸Šé™ï¼ˆå­—ç¬¦ï¼‰
