---
summary: "Use Synthetic's Anthropic-compatible API in "
read_when:
...
Synthetic exposes Anthropic-compatible endpoints.  registers it as the
...
Note: 's Anthropic client appends `/v1` to the base URL, so use
