...
export type ChannelAgentToolFactory = (params: { cfg?: Config }) => ChannelAgentTool[];
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: Config }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: Config }) => boolean;
  supportsCards?: (params: { cfg: Config }) => boolean;
