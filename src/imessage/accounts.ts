...
export function listIMessageAccountIds(cfg: Config): string[] {
...
export function resolveDefaultIMessageAccountId(cfg: Config): string {
...
function mergeIMessageAccountConfig(cfg: Config, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: Config): ResolvedIMessageAccount[] {
