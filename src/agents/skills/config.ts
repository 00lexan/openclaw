...
import type { Config, SkillConfig } from "../../config/config.js";
...
export function resolveConfigPath(config: Config | undefined, pathStr: string) {
...
export function isConfigPathTruthy(config: Config | undefined, pathStr: string): boolean {
...
export function resolveBundledAllowlist(config?: Config): string[] | undefined {
