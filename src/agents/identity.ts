import type { Config, HumanDelayConfig, IdentityConfig } from "../config/config.js";
...
export function resolveAckReaction(cfg: Config, agentId: string): string {
...
export function resolveIdentityName(cfg: Config, agentId: string): string | undefined {
