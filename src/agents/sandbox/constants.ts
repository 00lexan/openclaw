...
export const DEFAULT_SANDBOX_WORKSPACE_ROOT = path.join(os.homedir(), ".", "sandboxes");

export const DEFAULT_SANDBOX_IMAGE = "-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "-sbx-browser-";
