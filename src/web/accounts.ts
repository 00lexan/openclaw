...
export function listWhatsAppAuthDirs(cfg: Config): string[] {
...
export function hasAnyWhatsAppAuth(cfg: Config): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: Config): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: Config): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: Config; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: Config): ResolvedWhatsAppAccount[] {
