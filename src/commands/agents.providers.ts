...
function resolveDefaultAccountId(cfg: Config, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: Config): boolean {
...
export function summarizeBindings(cfg: Config, bindings: AgentBinding[]): string[] {
