...
export function applyZaiConfig(cfg: Config): Config {
...
export function applyOpenrouterProviderConfig(cfg: Config): Config {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: Config): Config {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: Config): Config {
...
export function applyOpenrouterConfig(cfg: Config): Config {
...
export function applyMoonshotProviderConfig(cfg: Config): Config {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: Config): Config {
...
export function applyMoonshotConfig(cfg: Config): Config {
...
export function applyMoonshotConfigCn(cfg: Config): Config {
...
export function applyKimiCodeProviderConfig(cfg: Config): Config {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: Config): Config {
...
export function applySyntheticProviderConfig(cfg: Config): Config {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: Config): Config {
...
export function applyXiaomiProviderConfig(cfg: Config): Config {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: Config): Config {
 ...
 */
export function applyVeniceProviderConfig(cfg: Config): Config {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: Config): Config {
