...
export function listSlackAccountIds(cfg: Config): string[] {
...
export function resolveDefaultSlackAccountId(cfg: Config): string {
...
function mergeSlackAccountConfig(cfg: Config, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: Config): ResolvedSlackAccount[] {
