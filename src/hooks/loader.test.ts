...
describe("loader", () => {
  ...
  beforeEach(async () => {
    ...
    originalBundledDir = process.env._BUNDLED_HOOKS_DIR;
    process.env._BUNDLED_HOOKS_DIR = "/nonexistent/bundled/hooks";
  });
  ...
  afterEach(async () => {
    ...
    if (originalBundledDir === undefined) {
      ...
      process.env._BUNDLED_HOOKS_DIR = originalBundledDir;
    }
