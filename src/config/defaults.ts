...
function resolveAnthropicDefaultAuthMode(cfg: Config): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: Config): Config {
...
export function applyTalkApiKey(config: Config): Config {
...
export function applyModelDefaults(cfg: Config): Config {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: Config): Config {
...
export function applyLoggingDefaults(cfg: Config): Config {
...
export function applyContextPruningDefaults(cfg: Config): Config {
...
export function applyCompactionDefaults(cfg: Config): Config {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
