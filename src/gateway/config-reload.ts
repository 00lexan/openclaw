...
import type { Config, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: Config): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  ...
  onHotReload: (plan: GatewayReloadPlan, nextConfig: Config) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: Config) => void;
  log: {
