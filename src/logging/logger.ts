...
// randomized path on macOS which made the â€œOpen logâ€ button a no-op.
export const DEFAULT_LOG_DIR = "/tmp/";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, ".log"); // legacy single-file path
