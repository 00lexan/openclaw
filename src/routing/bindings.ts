...
export function listBindings(cfg: Config): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: Config, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: Config) {
