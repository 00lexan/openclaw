...
${formatHelpExamples([
  [' agent --to +15555550123 --message "status update"', "Start a new session."],
  [' agent --agent ops --message "Summarize logs"', "Use a specific agent."],
  [
  ...
  [' agent --to +15555550123 --message "Summon reply" --deliver', "Deliver reply."],
  [
...
${theme.heading("Examples:")}
${formatHelpExamples([
  [' agents set-identity --agent main --name "" --emoji "ðŸ¦ž"', "Set name + emoji."],
  [" agents set-identity --agent main --avatar avatars/.png", "Set avatar path."],
  [
    " agents set-identity --workspace ~/./workspace --from-identity",
    "Load from IDENTITY.md.",
  ],
  [
    " agents set-identity --identity-file ~/./workspace/IDENTITY.md --agent main",
