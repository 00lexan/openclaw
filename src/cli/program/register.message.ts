...
${formatHelpExamples([
  [' message send --target +15555550123 --message "Hi"', "Send a text message."],
  [
    ' message send --target +15555550123 --message "Hi" --media photo.jpg',
  ...
  [
    ' message react --channel discord --target 123 --message-id 456 --emoji "âœ…"',
    "React to a message.",
  ],
])}
