...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: Config | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: Config): T | undefined {
  ...
  set(key: string, value: T, cfg: Config): void {
    this.resetIfConfigChanged(cfg);
  ...
  private resetIfConfigChanged(cfg: Config): void {
