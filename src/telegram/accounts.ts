...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env._DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: Config): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: Config): string {
...
function mergeTelegramAccountConfig(cfg: Config, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: Config): ResolvedTelegramAccount[] {
