...
export function listSignalAccountIds(cfg: Config): string[] {
...
export function resolveDefaultSignalAccountId(cfg: Config): string {
...
function mergeSignalAccountConfig(cfg: Config, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: Config): ResolvedSignalAccount[] {
