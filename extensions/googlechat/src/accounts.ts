...
export function listGoogleChatAccountIds(cfg: Config): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: Config): string {
...
export function listEnabledGoogleChatAccounts(cfg: Config): ResolvedGoogleChatAccount[] {
