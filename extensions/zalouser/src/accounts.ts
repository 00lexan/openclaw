...
export function listZalouserAccountIds(cfg: Config): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: Config): string {
...
function mergeZalouserAccountConfig(cfg: Config, accountId: string): ZalouserAccountConfig {
