...
`.invoke --each`) without adding new  code per workflow.
...
This extension depends on  internal modules (the embedded agent runner).
It is intended to ship as a **bundled**  extension (like `lobster`) and
