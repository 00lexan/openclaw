...
export function listMattermostAccountIds(cfg: Config): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: Config): string {
...
export function listEnabledMattermostAccounts(cfg: Config): ResolvedMattermostAccount[] {
