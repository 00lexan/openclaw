...
export function listZaloAccountIds(cfg: Config): string[] {
...
export function resolveDefaultZaloAccountId(cfg: Config): string {
...
function mergeZaloAccountConfig(cfg: Config, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: Config): ResolvedZaloAccount[] {
