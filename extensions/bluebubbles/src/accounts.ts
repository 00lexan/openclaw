...
export function listBlueBubblesAccountIds(cfg: Config): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: Config): string {
...
export function listEnabledBlueBubblesAccounts(cfg: Config): ResolvedBlueBubblesAccount[] {
